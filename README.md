...
### Правки
1) /api/profile/history Не хватает даты бронирования и названия зала. Если смотреть на то, что юзается на сайте
2) При выдаче избранных фильмов надо сделать, чтобы они выдавали как и просто api/film, то есть с данными из справочников
3) Добавление/удаление фильма из избранного (посылаю токен и id фильма) это 100%.
При загрузке страницы фильма при условии авторизации в системе посылается запрос, состоящий из токена и id фильма, ответ булевый (наверное), добавлен ли фильм в избранное
